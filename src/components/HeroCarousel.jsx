...
<Carousel slideInterval={5000} indicators={false}>
  <div className="relative flex h-full items-center justify-start bg-cover bg-right p-8"
       style={{ backgroundImage: "url('Collections-Placeholder/black-collection.jpg')", backgroundSize: "30%", backgroundRepeat: "no-repeat", backgroundPosition: "right center" }}>
  ...
  <div className="relative flex h-full items-center justify-start bg-cover bg-right p-8"
       style={{ backgroundImage: "url('Collections-Placeholder/clear-collection.jpg')", backgroundSize: "30%", backgroundRepeat: "no-repeat", backgroundPosition: "right center" }}>
    <div className="absolute inset-0 bg-black/30" />
    <div className="z-10 max-w-xl text-left">
  ...
  <div className="relative flex h-full items-center justify-start bg-cover bg-right p-8"
       style={{ backgroundImage: "url('Collections-Placeholder/green-collection.jpg')", backgroundSize: "30%", backgroundRepeat: "no-repeat", backgroundPosition: "right center" }}>
    <div className="absolute inset-0 bg-black/30" />
    <div className="z-10 max-w-xl text-left">
  ...
  <div className="relative flex h-full items-center justify-start bg-cover bg-right p-8"
       style={{ backgroundImage: "url('Collections-Placeholder/red-collection.jpg')", backgroundSize: "30%", backgroundRepeat: "no-repeat", backgroundPosition: "right center" }}>
    <div className="absolute inset-0 bg-black/30" />
    <div className="z-10 max-w-xl text-left">
  ...
  <div className="relative flex h-full items-center justify-start bg-cover bg-right p-8"
       style={{ backgroundImage: "url('Collections-Placeholder/grey-collection.jpg')", backgroundSize: "30%", backgroundRepeat: "no-repeat", backgroundPosition: "right center" }}>
    <div className="absolute inset-0 bg-black/30" />
    <div className="z-10 max-w-xl text-left">
